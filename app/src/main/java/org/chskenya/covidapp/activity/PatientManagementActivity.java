...
import org.chskenya.covidapp.adapter.PatientManagementInfoAdapter;
...
public class PatientManagementActivity extends AppCompatActivity {
    private static final String TAG = "PatientManagement";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (user == null) {
            ...
            startActivity(new Intent(PatientManagementActivity.this, LoginActivity.class));
            finish();
        }
        ...
        //setup layouts
        layouts = new int[]{
                R.layout.patient_management_info1,
                R.layout.patient_management_info2,
                R.layout.patient_management_info3
        };

        PatientManagementInfoAdapter adapter = new PatientManagementInfoAdapter(this, layouts);
        ...
        next.setOnClickListener(v -> {
            ...
            if (current < layouts.length) {
                ...
                runOnUiThread(() -> new SweetAlertDialog(PatientManagementActivity.this, SweetAlertDialog.SUCCESS_TYPE)
                        ...
                        .setConfirmButton(getString(R.string.main_activity), dialog -> {
                            ...
                            startActivity(new Intent(PatientManagementActivity.this, PatientHomePageActivity.class));
                            finish();
                        })
                        .show());
            }
    ...
    private void initViews() {
        ...
        InitialDataDB initialDataDB = InitialDataDB.getInstance(PatientManagementActivity.this);
        ...
        patientDB = PatientDB.getInstance(PatientManagementActivity.this);
    }
