...
import org.chskenya.covidapp.adapter.LinkageInfoAdapter;
...
public class LinkageActivity extends AppCompatActivity {
    private static final String TAG = "LinkageActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (user == null) {
            ...
            startActivity(new Intent(LinkageActivity.this, LoginActivity.class));
            finish();
        }

        //setup layouts
        layouts = new int[]{
                R.layout.linkage_info1,
                R.layout.linkage_info2,
                R.layout.linkage_info3
        };

        LinkageInfoAdapter linkageInfoAdapter = new LinkageInfoAdapter(this, initialData, layouts);
        viewPager.setAdapter(linkageInfoAdapter);
    ...
    private void initViews() {
        ...
        initialDataDB = InitialDataDB.getInstance(LinkageActivity.this);
